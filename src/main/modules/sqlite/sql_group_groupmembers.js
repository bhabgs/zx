/**
 * 根据接口groupListApi的返回值中的groupmembers构建此表
 */
/**
 * 每个表自定义结构
 */
const T = {
  name: "t_group_groupmembers", //表名
  fields: [
    //表字段
...
const DELETE_GROUP_GROUPMEMBERS_BY_ID = `delete from ${T.name} where id=?`;
const DELETE_GROUP_GROUPMEMBERS_BY_ID_TEMPLATE = "id";
...
export const GROUP_GROUPMEMBERS_SQL = {
  CREATE_TABLE_GROUP_GROUPMEMBERS: CREATE_TABLE, //创建表
  DROP_TABLE_GROUP_GROUPMEMBERS: DROP_TABLE, //删除表
  INSERT_OR_REPLACE_GROUP_GROUPMEMBERS: INSERT_OR_REPLACE, //插入或更新行
  QUERY_GROUP_GROUPMEMBERS: QUERY, //全量查询
  QUERY_GROUP_GROUPMEMBERS_BY_KEY: QUERY_BY_KEY, //根据主键查询
  QUERY_GROUP_GROUPMEMBERS_FOR_SEARCH_ALL: QUERY_FOR_SEARCH_ALL, //全字段检索查询，速度较慢
  DELETE_GROUP_GROUPMEMBERS: DELETE, //清空数据
  DELETE_GROUP_GROUPMEMBERS_BY_ID,
  DELETE_GROUP_GROUPMEMBERS_BY_KEY: DELETE_BY_KEY //根据主键删除行
};

export const GROUP_GROUPMEMBERS_SQL_TEMPLATE = {
  ...
  [DELETE_GROUP_GROUPMEMBERS_BY_ID]: DELETE_GROUP_GROUPMEMBERS_BY_ID_TEMPLATE,
  [DELETE_BY_KEY]: DELETE_BY_KEY_TEMPLATE
};

export const GROUP_GROUPMEMBERS = T