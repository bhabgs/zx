/**
 * 根据接口groupListApi的返回值中的grouprobots构建此表
 */
const T = {
  name: "t_group_grouprobots", //表名
  fields: [
    //表字段
    { field: "id", type: "char(50)", primaryKey: true },
    { field: "chatAccountId", type: "char(50)", primaryKey: true },
    { field: "chatRobotCorpId", type: "char(50)" },
    { field: "chatRobotCreator", type: "char(50)" },
    { field: "chatRobotDetail", type: "text" },
    { field: "chatRobotImage", type: "text" },
    { field: "chatRobotIp", type: "char(50)" },
    { field: "chatRobotKeyWord", type: "char(50)" },
    { field: "chatRobotName", type: "char(50)" },
    { field: "chatRobotState", type: "int" },
    { field: "chatRobotType", type: "int" },
    { field: "chatRobotsecret", type: "char(50)" },
    { field: "ipEnable", type: "int" },
    { field: "keywordEnable", type: "int" },
    { field: "secretEnable", type: "int" },
    { field: "serviceAddress", type: "char(50)" },
    { field: "webHookUrl", type: "text" }
  ]
};
...
const DELETE_GROUP_GROUPROBOTS_BY_ID = `delete from ${T.name} where id=?`;
const DELETE_GROUP_GROUPROBOTS_BY_ID_TEMPLATE = "id";
...
export const GROUP_GROUPROBOTS_SQL = {
  CREATE_TABLE_GROUP_GROUPROBOTS: CREATE_TABLE, //创建表
  DROP_TABLE_GROUP_GROUPROBOTS: DROP_TABLE, //删除表
  INSERT_OR_REPLACE_GROUP_GROUPROBOTS: INSERT_OR_REPLACE, //插入或更新行
  QUERY_GROUP_GROUPROBOTS: QUERY, //全量查询
  QUERY_GROUP_GROUPROBOTS_BY_KEY: QUERY_BY_KEY, //根据主键查询
  QUERY_GROUP_GROUPROBOTS_FOR_SEARCH_ALL: QUERY_FOR_SEARCH_ALL, //全字段检索查询，速度较慢
  DELETE_GROUP_GROUPROBOTS: DELETE, //清空数据
  DELETE_GROUP_GROUPROBOTS_BY_ID,
  DELETE_GROUP_GROUPROBOTS_BY_KEY: DELETE_BY_KEY //根据主键删除行
};

export const GROUP_GROUPROBOTS_SQL_TEMPLATE = {
  ...
  [DELETE_GROUP_GROUPROBOTS_BY_ID]: DELETE_GROUP_GROUPROBOTS_BY_ID_TEMPLATE,
  [DELETE_BY_KEY]: DELETE_BY_KEY_TEMPLATE
};

export const GROUP_GROUPROBOTS = T