...
/**
 * 名称虽然是群组，但数据来源是接口getTopAndDisturbList的返回值构建的此表
 */
const T = {
  name: "t_group_attribute", //表名
  fields: [
    //表字段
    { field: "id", type: "char(50)", primaryKey: true },
    { field: "accountId", type: "char(50)" },
    { field: "beId", type: "char(50)" },
    { field: "corpId", type: "int" },
    { field: "createAt", type: "char(50)" },
    { field: "isDisturb", type: "int" },
    { field: "isTop", type: "int" },
    { field: "objectType", type: "int" },
...
export const GROUP_ATTRIBUTE_SQL = {
  CREATE_TABLE_GROUP_ATTRIBUTE: CREATE_TABLE, //创建表
  DROP_TABLE_GROUP_ATTRIBUTE: DROP_TABLE, //删除表
  INSERT_OR_REPLACE_GROUP_ATTRIBUTE: INSERT_OR_REPLACE, //插入或更新行
  QUERY_GROUP_ATTRIBUTE: QUERY, //全量查询
  QUERY_GROUP_ATTRIBUTE_BY_KEY: QUERY_BY_KEY, //根据主键查询
  QUERY_GROUP_ATTRIBUTE_FOR_SEARCH_ALL: QUERY_FOR_SEARCH_ALL, //全字段检索查询，速度较慢
  DELETE_GROUP_ATTRIBUTE: DELETE, //清空数据
  DELETE_GROUP_ATTRIBUTE_BY_KEY: DELETE_BY_KEY //根据主键删除行
};

export const GROUP_ATTRIBUTE_SQL_TEMPLATE = {
...
export const GROUP_ATTRIBUTE = T