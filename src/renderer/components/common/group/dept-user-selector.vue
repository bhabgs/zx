<template>
  <div class="dept-user-selector" :style="{ '--type-color': typeColor }">
    <div
    ...
    <check-row
      :class="['check-all-row', { checked: isCheckAll }]"
      :checked="isCheckAll"
      @checked="toggleCheckAll"
    >
      <span class="text">全选</span>
      <span class="count">{{ showNumCuttent }}人</span>
      <mask-icon class="empty-icon" size="12" />
    </check-row>
